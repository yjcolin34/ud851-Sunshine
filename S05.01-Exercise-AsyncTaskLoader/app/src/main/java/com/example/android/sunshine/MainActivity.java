    ...
    public Loader<String []> onCreateLoader(int id, final Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                String loactionQuery = SunshinePreferences.getPreferredWeatherLocation(MainActivity.this);
                URL weatherRequestURL = NetworkUtils.buildUrl(loactionQuery);

                try {
                    String httpResponse = NetworkUtils.getResponseFromHttpUrl(weatherRequestURL);
                    String [] simpleWeatherData = new String[0];
                    try {
                        simpleWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, httpResponse);
